...
const Navbar = ({ setNotice }) => {
  ...
  return (
    <>
      ...
      {/* Dedicated Full Screen Opaque Mobile Menu Overlay */}
      <div 
        className={`fixed inset-0 z-[9999] bg-white transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] md:hidden flex flex-col justify-between pt-6 pb-12 px-6 sm:px-8 ${
      ...
      >
        <div className="flex items-center justify-between py-2 border-b border-[#f5f5f7]">
          ...
          <button 
            ...
            className="p-3 text-[#1d1d1f] bg-[#f5f5f7] hover:bg-[#e5e5ea] rounded-full transition-all duration-300 cursor-pointer active:scale-95 shadow-sm"
